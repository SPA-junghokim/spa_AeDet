...
from layers.heads.aedet_head_2stage import AeDetHead
...
class AeDet(nn.Module):
    ...
    def __init__(self, backbone_conf, head_conf, is_train_depth=False):
        ...
        self.first_head = AeDetHead(**head_conf)
    ...
    def forward(
        ...
        if self.is_train_depth and self.training:
            ...
            # Deform Attn
            x = self.relu(self.ms_deform_attn(x_dense, value=x_sparse_final))
