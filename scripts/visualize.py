...
from dataset.nusc_mv_det_dataset import \
...
def parse_args():
    ...
    parser.add_argument('data_pkl', default='data/nuScenes/nuscenes_12hz_infos_train_100data2.pkl',
                        help='pkl data path.')
...
def demo(
    ...
    for corners in pred_corners: # (8, 3)
        lines = get_bev_lines(corners)
        for line in lines:
