...
class MultiScaleDeformableAttnFunction_fp32(Function):
    ...
    def backward(ctx, grad_output):
        ...
        ext_module.ms_deform_attn_backward(value,value_spatial_shapes,value_level_start_index,sampling_locations,attention_weights,grad_output.contiguous(),grad_value,grad_sampling_loc,grad_attn_weight,im2col_step=ctx.im2col_step)
        grad_sampling_loc[grad_sampling_loc.isnan()] = 0
        grad_attn_weight[grad_attn_weight.isnan()] = 0
        return grad_value, None, None, \
            grad_sampling_loc, grad_attn_weight, None
