...
class AnchorFreeMono3DHeadCenter(BaseMono3DDenseHead):
    ...
    def __init__(
            ...
            test_cfg=None,
            init_cfg=None):
        super(AnchorFreeMono3DHeadCenter, self).__init__(init_cfg=init_cfg)
        ...
        self.use_direction_classifier = False # chgd
