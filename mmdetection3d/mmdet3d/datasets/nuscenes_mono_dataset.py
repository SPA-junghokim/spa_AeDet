...
class NuScenesMonoDataset(CocoDataset):
    ...
    def __init__(self,
        ...
        self.seg_prefix = seg_prefix # None
        self.proposal_file = proposal_file # None
    ...
    def _parse_ann_info(self, img_info, ann_info):
        ...
        #seg_map = img_info['filename'].replace('jpg', 'png') # org
        seg_map = img_info['file_name'].replace('jpg', 'png') # chgd

        ann = dict(
            bboxes=gt_bboxes, # (objnum, 4)
            labels=gt_labels, # (objnum)
            gt_bboxes_3d=gt_bboxes_cam3d, # CameraInstance3DBoxes(objnum, 9)
            gt_labels_3d=gt_labels_3d, # (objnum)
            attr_labels=attr_labels,
            centers2d=centers2d,
            depths=depths, # (objnum)
