...
from models.aedet_polar_mm import AeDet
...
class AeDetLightningModel(LightningModule):
    ...
    def get_depth_loss(self, depth_labels, depth_preds):
        ...
        inds = torch.max(depth_labels, dim=1).indices # todoss
...
def run_cli():
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_2key_polar_mgt0_7split_dimx_mm',
                        )
