...
from models.aedet_mm_multi_scale_2stage import AeDet
...
class AeDetLightningModel(LightningModule):
    ...
    def training_step(self, batch):
        ...
        preds, depth_preds, first_preds = self(sweep_imgs, mats)
        ...
        self.log('first_detection_loss', first_detection_loss)
...
def run_cli():
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_multi_scale_mm_2stage')
