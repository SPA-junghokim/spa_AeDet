...
from models.aedet_memvit_multi_scale import AeDet
...
class AeDetLightningModel(LightningModule):
    ...
    def __init__(self,
        ...
        self.backbone_conf['agg_type'] = agg_type
        
        # self.head_conf['bev_backbone_conf']['in_channels'] = backbone_conf['output_channels'] * (2)
    ...
    def training_step(self, batch):
        ...
        if isinstance(self.model, torch.nn.parallel.DistributedDataParallel):
            ...
            #detection_loss, ce_loss, dice_loss = self.model.module.loss(targets, preds)
        else:
            targets = self.model.get_targets(gt_boxes, gt_labels)
            detection_loss = self.model.loss(targets, preds)
            #detection_loss, ce_loss, dice_loss = self.model.loss(targets, preds)
        ...
        return detection_loss + depth_loss #+ ce_loss + dice_loss
...
def run_cli():
    ...
    parent_parser.add_argument('--agg_type',  default='cnn', type=str)
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_memvit_multi_scale')
