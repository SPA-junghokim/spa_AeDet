...
from models.aedet_mm_multi_scale_2stage_gl import AeDet
...
class AeDetLightningModel(LightningModule):
    ...
    def training_step(self, batch):
        ...
        if isinstance(self.model, torch.nn.parallel.DistributedDataParallel):
            ...
            detection_loss, h_loss1, h_loss2, h_loss3, h_loss4 = self.model.module.loss(targets, preds)
        else:
            targets = self.model.get_targets(gt_boxes, gt_labels)
            detection_loss, h_loss1, h_loss2, h_loss3, h_loss4 = self.model.loss(targets, preds)
        ...
        self.log('heat_map1_loss', h_loss1)
        self.log('heat_map2_loss', h_loss2)
        self.log('heat_map3_loss', h_loss3)
        self.log('heat_map4_loss', h_loss4)
        return detection_loss + depth_loss + h_loss1 + h_loss2 + h_loss3 + h_loss4
...
def run_cli():
    ...
    parent_parser.add_argument('--convlstm_layer', default = 1, type=int)
    parent_parser.add_argument('--deform_conv_lstm', default=True)
    parent_parser.add_argument('--motion_gate', default=True)
    parent_parser.add_argument('--bevdepth', default=True)
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_multi_scale_mm_2stage_gl')
