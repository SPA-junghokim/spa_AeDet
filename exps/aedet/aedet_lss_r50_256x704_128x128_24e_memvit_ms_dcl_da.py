...
from models.aedet_memvit_ms_dcl_da import AeDet
...
def run_cli():
    ...
    parent_parser.add_argument('--motion_gate', default=False)
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_memvit_ms_dcl_da')
