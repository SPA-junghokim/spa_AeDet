...
from models.aedet_mm_2stage import AeDet
...
class AeDetLightningModel(LightningModule):
    ...
    def __init__(self,
        ...
        self.head_conf['bev_neck_conf']['in_channels'] = [
            backbone_conf['output_channels'] * (len(self.key_idxes) + 1), 160, 320, 640
        ]
...
def run_cli():
    ...
    parser.set_defaults(profiler='simple',
                        ...
                        precision=16,
                        default_root_dir='./outputs/aedet_lss_r50_256x704_128x128_24e_2key_7split_2stage')
